...
const defaultSections: Section[] = [
  { id: 1, title: 'Sach- und Vermögensschutz', description: 'Versicherungsprodukte, Vertragsgrundlagen und Schadenfälle verständlich aufbauen.', icon: '🛡️', color: 'from-blue-500 to-cyan-500', topics: [
  ...
  { id: 3, title: 'Steuerung, Zusammenarbeit und Leadership', description: 'Berufsausbildung, Führung sowie den praxisbezogenen Prüfungsteil meistern.', icon: '🎯', color: 'from-amber-500 to-orange-500', topics: [
